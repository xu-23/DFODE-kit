...
file_path = f"{DFODE_ROOT}/tutorials/twoD_HIT_flame/1_sample_train/tutorial_data_1.0.h5"
save_path1 = f"{DFODE_ROOT}/tutorials/twoD_HIT_flame/2_model_test/priori/label.h5"
save_path2 = f"{DFODE_ROOT}/tutorials/twoD_HIT_flame/2_model_test/priori/model_output.h5"
